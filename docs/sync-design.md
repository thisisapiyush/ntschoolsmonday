...
COMPLEXITY_BUDGET_EXHAUSTED on monday and 429 on Jira are treated as retryable
...
the same pattern as monday's cursor-based items_page, iterating until the
